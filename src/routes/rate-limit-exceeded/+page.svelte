<script>
	...
	import { goto } from '$app/navigation'; // Changed from @sapper/app to $app/navigation
	import config from '$lib/data/config.json'; // Adjust path if you moved your config file; otherwise, use a relative path
